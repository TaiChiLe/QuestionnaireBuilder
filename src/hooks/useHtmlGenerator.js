...
export const useHtmlGenerator = () => {
    ...
    const generateHtmlPreview = useMemo(() => {
        return (droppedItems) => {
                    ...
                    .map((item) => {
                        ...
                        switch (item.type) {
                            case 'page':
                                ...
                                html += `${indent}  <h2 style="margin: 0 0 10px 0; font-size: 18px; font-weight: bold; color: #333;">${item.title || item.label
                                    }</h2>\n`;
                            ...
                            case 'question':
                                ...
                                html += `${indent}  <label style="display: block; margin-bottom: 8px; font-weight: normal; color: #333; font-size: 14px;">${item.label
                            ...
                            case 'table':
                                ...
                                if (item.children && item.children.length > 0) {
                                    ...
                                    item.children.forEach((field) => {
                                        html += `${indent}        <th style="padding: 12px; border: 1px solid #ccc; text-align: left; font-weight: normal; color: #333;">${field.label
                                            }${field.required
                            ...
                            case 'table-field':
                                ...
                                html += `${indent}  <div style="font-weight: 500; color: #333;">${item.label
                                    }${item.required ? ' <span style="color: #f44336;">*</span>' : ''
                                    }</div>\n`;
